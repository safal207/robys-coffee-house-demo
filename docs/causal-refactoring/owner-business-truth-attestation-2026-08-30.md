...
This record intentionally does not copy private conversation content or personal data. The exact values and their canonical digests define the attested scope; review and merge of the associated pull request provide durable repository-account accountability.
