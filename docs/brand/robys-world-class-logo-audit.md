...
The website now uses one path-based Roby's identity family across wordmarks, favicon, map mark, 404 and owner utility pages. The approved digital tokens are red `#E21B23`, ink `#111111`, and warm paper `#F5F5F2`.

## Closed findings

| Former finding | Current state | Evidence contract |
|---|---|---|
| Favicon used a different monogram | Closed | `icon.svg` reuses the approved organic-O path and contains no text nodes |
