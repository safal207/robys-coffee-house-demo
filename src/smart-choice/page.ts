...
const copy = {
  tr: {
    ...
    trustSafe: "Seçiminizi değiştirebilirsiniz",
    back: "Geri",
    ...
    resultsLead: "Herkes için porsiyonlar ve toplam. Bir seçim yapın, ardından sepetinize ekleyin.",
    best: "En iyi eşleşme",
    ...
    selectedTitle: "Seçiminizi kontrol edin.",
    ...
    noMatchTitle: "Bu tercihlerin tümüne uyan bir seçenek bulamadık.",
    ...
    why: "Neden uygun",
    noOrder: "Kontrol ettikten sonra ekleyin",
    price: "Toplam fiyat"
  },
  en: {
    fullMenu: "Full menu",
    ...
    trustSafe: "You can change your mind",
    back: "Back",
    restart: "Restart",
    step: "Step",
    of: "of",
    ...
    resultsLead: "Portions and total for everyone. Choose an option, then add it to your order.",
    best: "Best match",
    economy: "Lower price",
  ...
  ru: {
    ...
    trustSafe: "Выбор можно изменить",
    back: "Назад",
    ...
    resultsLead: "Порции и сумма на всех. Выберите вариант, затем добавьте его в заказ.",
    ...
    selectedTitle: "Проверьте ваш выбор.",
    ...
    noMatchTitle: "Пока нет варианта, который подходит под все пожелания.",
    ...
    components: "Состав",
    why: "Почему подходит",
    noOrder: "Добавление после проверки",
    price: "Итоговая цена"
  }
