...
const copy = {
  tr: {
    ...
    welcomeLead: "Beş kısa seçim yapın. Size bütçenize ve isteğinize uyan doğrulanmış bir Roby's eşleşmesi gösterelim.",
    start: "Seçime başla",
    ...
    noMatchTitle: "Bu tercihlerle doğrulanmış bir kombo bulamadık.",
  ...
  en: {
    ...
    welcomeLead: "Make five quick choices and get a verified Roby's pairing that fits your preferences and budget.",
    ...
    noMatchTitle: "We could not find a confirmed combo for all these preferences.",
  ...
  ru: {
    ...
    welcomeLead: "Сделайте пять коротких выборов — и получите подтверждённое сочетание Roby's под ваши предпочтения и бюджет.",
    start: "Начать выбор",
    ...
    noMatchTitle: "Мы не нашли подтверждённое комбо под все эти условия.",
