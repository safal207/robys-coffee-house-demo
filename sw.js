const CACHE_VERSION = "robys-offline-v65-20260907-guest-journey-d16fc23e122d-58d387ca0c01-96b566c9731e";
...
const CORE_ASSETS = [
  ...
  "./bootstrap-v2.js?v=b2dbb1939952",
  "./android-handoff.js",
  "./android-native-product-frame.js?v=137523311e28",
  ...
  "./order-launcher.js?v=67ef8d882b71",
  "./order-store.js?v=ea7acc7113ac",
  "./order-shell.js?v=6b0f97c71c65",
  ...
  "./smart-choice/app-v2.js?v=67033c81a867",
...
async function cachedResponse(request) {
  ...
  const requiresExactRevision =
    ...
    url.pathname.endsWith("/android-native-product-frame.js") ||
