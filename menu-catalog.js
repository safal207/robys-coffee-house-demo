export const menuCopy = {
  tr: {
    ...
    smartChoice: "Akıllı seçim",
    cart: "Siparişim",
    cartTitle: "Sipariş özeti",
    cartEmpty: "Henüz bir seçim eklemediniz.",
    total: "Toplam",
    close: "Kapat",
    continueMenu: "Menüye devam et",
    quantity: "Adet",
  ...
  en: {
    ...
    total: "Total",
    close: "Close",
    continueMenu: "Continue browsing",
    quantity: "Quantity",
  ...
  ru: {
    ...
    smartChoice: "Умный подбор",
    cart: "Мой заказ",
    cartTitle: "Расчёт заказа",
    cartEmpty: "Вы пока ничего не добавили.",
    total: "Итого",
    close: "Закрыть",
