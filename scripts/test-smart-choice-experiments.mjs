...
try {
  ...
  assert(html.indexOf('src="experiments-runtime.js') < html.indexOf('src="analytics-runtime.js'), "experiment assignment must load before analytics");
  assert(buildSource.includes('entryPoints: ["src/smart-choice/experiments.ts"]'));
  assert(buildSource.includes('revisionFor("smart-choice/experiments-runtime.js")'));
