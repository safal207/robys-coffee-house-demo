...
const stages = [
  ...
  { depth: "D4", label: "Independent review", detail: "Exact-head human approval, maintainer attestation or optional automated review", defaultStatus: "waiting" },
...
\`claim → artifacts → executable checks → mutation challenge → independent review → dispositions → Proof Seal\`

No external AI provider or provider quota is required. Optional automated reviews add evidence but do not own approval or merge authority.
