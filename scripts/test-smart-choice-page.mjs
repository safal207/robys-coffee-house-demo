...
const bundle = readFileSync("smart-choice/app-runtime.js", "utf8");
...
assert(/src="app-runtime\.js\?v=[a-f0-9]{12}"/.test(html), "Smart Choice app revision is not synchronized");
