...
assert.ok(Buffer.byteLength(loaderSource, "utf8") < 1000, "Always-loaded reveal loader must stay under 1.0 KB to remain inside the 5% JS regression envelope");
...
assert.match(loaderSource, /const TARGET="src\/products\/menu-v1\/desserts--san-sebastian-cheesecake\.webp"/, "Reveal loader must match the relative src form written by the menu runtime");
assert.match(loaderSource, /URLSearchParams\(location\.search\)\.get\("product"\)/, "Deck product links must use an explicit product query parameter");
