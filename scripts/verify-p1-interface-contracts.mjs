...
assert(routeUrls.length >= 3, "CTA-001", `Expected route CTAs, found ${routeUrls.length}`);
...
assert(qaRuntime.includes('HERO_VIDEO = "src/robys-ambience-clean.mp4?v=20260711-1'), "ASSET-001", "Hero asset changed");
