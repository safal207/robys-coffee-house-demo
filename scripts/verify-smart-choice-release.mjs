...
requireText(html, `src="pwa.js?v=${SHARED_SERVICE_WORKER_REVISION}"`, "Smart Choice must update and observe the shared offline runtime");
...
requireText(smartChoicePwa, `../sw.js?v=${SHARED_SERVICE_WORKER_REVISION}`, "Smart Choice PWA bootstrap must register the current shared worker");
