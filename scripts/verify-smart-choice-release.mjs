...
requireText(html, 'src="pwa.js?v=menu-catalog-20260904-1"', "Smart Choice must update and observe the shared offline runtime");
...
requireText(smartChoicePwa, '../sw.js?v=menu-catalog-20260904-1', "Smart Choice PWA bootstrap must register the current shared worker");
