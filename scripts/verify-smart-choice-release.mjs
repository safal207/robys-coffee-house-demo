...
requireText(html, 'src="pwa.js?v=premium-styles-20260904-1"', "Smart Choice must update and observe the shared offline runtime");
...
requireText(smartChoicePwa, '../sw.js?v=premium-styles-20260904-1', "Smart Choice PWA bootstrap must register the current shared worker");
